	...
	return (
		<div className="flex items-center justify-around flex-col-reverse lg:flex-row mx-12">
			<div>
				...
				<h1 
					className="text-center mx-auto lg:text-start relative text-light-900 dark:text-dark-200 dt py-2 font-[monospace] name-typewriter-animation whitespace-nowrap w-fit text-2xl sm:text-3xl xl:text-7xl md:text-5xl">
					Leonardo Lazzaretti.
				</h1> 

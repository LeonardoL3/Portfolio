	...
	return (
		<section>
			<div className='flex flex-col gap-12 justify-center items-center h-screen'>
				...
				<Link href='/'>
					<Button aria-label="back to home" className="border-2 p-4 rounded-md flex items-center gap-2 text-dark-100 dark:text-light-100 dark:border-light-100 border-dark-900 hover:scale-110 transition-all">
